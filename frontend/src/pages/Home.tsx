  ...
  return (
    ...
    <div className="home w-full p-0 m-0">
      ...
      <div className="w-full grid grid-cols-1 sm:grid-cols-2 xl:grid-cols-4 grid-flow-dense auto-rows-[minmax(200px,auto)] xl:auto-rows-[minmax(150px,auto)] gap-3 xl:gap-3 px-0">
        <div className="box col-span-full sm:col-span-1 xl:col-span-1 3xl:row-span-1">
          <ChartBox
            chartType={"line"}
            IconBox={MdGroup}
            title="Total Users"
        ...
        <div className="box row-span-3 col-span-full sm:col-span-1 xl:col-span-4 3xl:row-span-5">
          <ChartBox
            chartType={"bar"}
            title="Total Visit"
        ...
        <div className="box col-span-full sm:col-span-1 xl:col-span-4 3xl:row-span-2">
          <ChartBox
            chartType={"bar"}
            title="Total Profit"
